...
lipstick_recorder_manager_create_recorder(struct lipstick_recorder_manager *lipstick_recorder_manager, struct wl_output *output)
{
	...
	recorder = wl_proxy_marshal_flags((struct wl_proxy *) lipstick_recorder_manager,
			 LIPSTICK_RECORDER_MANAGER_CREATE_RECORDER, &lipstick_recorder_interface, wl_proxy_get_version((struct wl_proxy *) lipstick_recorder_manager), 0, NULL, output);
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) lipstick_recorder,
			 LIPSTICK_RECORDER_DESTROY, NULL, wl_proxy_get_version((struct wl_proxy *) lipstick_recorder), WL_MARSHAL_FLAG_DESTROY);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) lipstick_recorder,
			 LIPSTICK_RECORDER_RECORD_FRAME, NULL, wl_proxy_get_version((struct wl_proxy *) lipstick_recorder), 0, buffer);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) lipstick_recorder,
			 LIPSTICK_RECORDER_REPAINT, NULL, wl_proxy_get_version((struct wl_proxy *) lipstick_recorder), 0);
}
